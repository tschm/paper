...
This document is a guide to contributing to paper
...
You'll need to build paper locally in order to start editing code.
Please install [task](https://taskfile.dev).

To install paper from source, clone the Github
...
To contribute to paper, send us pull requests.
For those new to contributing, check out Github's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the paper
...
If you'd like to add a new feature to paper, please do propose your
...
- Read the paper source and enhance the documentation,
  or address TODOs
...
paper tests live in the directory `tests`,
